# Generated by Django 5.1.6 on 2025-03-24 19:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tenancy_agreements', to='rent_in_app.tenant')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('phone_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='rent_in_app.tenant')),
            ],
        ),
        migrations.CreateModel(
            name='Unit',
